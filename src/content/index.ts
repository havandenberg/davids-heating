...
export const projects = [
  ...
  {
    caption: '',
    src: `${ASSETS_PATH}/project-3.jpg`,
    thumbnail: `${ASSETS_PATH}/project-3.jpg`,
    thumbnailHeight: 225,
    thumbnailWidth: 300,
  },
  {
    caption: '',
    src: `${ASSETS_PATH}/project-4.jpg`,
    thumbnail: `${ASSETS_PATH}/project-4.jpg`,
    thumbnailHeight: 225,
    thumbnailWidth: 169,
  },
  {
  ...
  {
    caption: '',
    src: `${ASSETS_PATH}/project-6.jpg`,
    thumbnail: `${ASSETS_PATH}/project-6.jpg`,
    thumbnailHeight: 225,
    thumbnailWidth: 300,
  },
];
